...
pub mod prelude {
    ...
    // Assert macros
    pub use super::{
        add_failure, add_failure_at, assert_pred, assert_that, expect_eq, expect_exit,
        expect_false, expect_float_eq, expect_ge, expect_gt, expect_le, expect_lt, expect_ne,
        expect_near, expect_pred, expect_that, expect_true, fail, succeed, verify_eq, verify_exit,
