...
pub trait AndMatcherExt<T: Debug>: Matcher {
    ...
    // methods is stable.
    fn and<Right: Matcher>(self, right: Right) -> ConjunctionMatcher<T, Self, Right>
    where
        Self: Sized,
    {
...
impl<T: Debug, M> AndMatcherExt<T> for M where M: Matcher {}
...
impl<T: Debug, M1: Matcher, M2: Matcher> Matcher for ConjunctionMatcher<T, M1, M2> {
