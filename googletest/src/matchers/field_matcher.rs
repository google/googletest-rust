...
/// # fn should_pass() -> Result<()> {
/// verify_that!(AStruct{a_field: "32".into()}, field!(ref &AStruct.a_field, eq("32")))?;
/// #     Ok(())
/// # }
/// # should_pass().unwrap();
/// ```
...
pub mod internal {
    ...
    impl<ExtractorT, InnerMatcher: MatcherExt> MatcherExt for FieldMatcher<ExtractorT, InnerMatcher> {}
    ...
    impl<ExtractorT, InnerMatcher: MatcherExt> MatcherExt
        for FieldRefMatcher<ExtractorT, InnerMatcher>
    {
    }
