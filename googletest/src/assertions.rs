...
/// Matches the given expr Result against the Result::Ok(anything()) matcher, marking the test as
/// failed but continuing execution if it does not match.
///
/// This is a *non-fatal* assertion: the test continues
/// execution in the event of assertion failure.
...
/// Matches the given expr Result against the Result::Ok(anything()) matcher, panicking if it does
/// not match.
///
/// ```should_panic
/// # use googletest::prelude::*;
