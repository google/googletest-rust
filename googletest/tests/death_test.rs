...
#[gtest]
fn test_expect_death_success() -> Result<()> {
    verify_death!(exit(1), contains_substring(""))
}

#[gtest]
fn test_expect_death_macro_success() {
    expect_death!(exit(1), contains_substring(""));
}

#[gtest]
fn test_expect_death_failure_when_lived() -> Result<()> {
...
#[gtest]
fn test_expect_death_failure_when_exited_successfully() -> Result<()> {
